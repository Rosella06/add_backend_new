...
export const CreatePinCodeSchema = z.object({
  id: z
    .string()
    .regex(customIdRegex, { message: 'Invalid user ID format.' }),
  pinCode: z
    .string()
...
export const CreateUserSchema = z.object({
  ...
  userPassword: z.string().min(3, { message: 'Username must be at least 3 characters' }),
  displayName: z.string().min(1, { message: 'DisplayName must be at least 1 characters' }),
